...
export interface ImportPhotosPageProps extends SharedPageProps {}

const ImportPhotosPage: PageComponent<ImportPhotosPageProps> = () => {
  // == Create album
  const initialValues = {
    title: "",
...
ImportPhotosPage.layout = buildLayout<ImportPhotosPageProps>(page => (
  <>
    <AppLayout
      title="Import photos"
      breadcrumbs={[
        { title: "Home", href: routes.home.show.path() },
        { title: "Import photos", href: routes.photos.new.path() },
      ]}
      withContainer
      containerSize="xs"
      withGutter
...
export default ImportPhotosPage;
